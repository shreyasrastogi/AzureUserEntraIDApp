...
- **Azure Static Web Apps , Azure Functions , Entra ID , Azure AI Language , Microsoft Graph API , SQL Server Database , Microsoft Data Builder API , Azure Communication Services**
